...
const HomePage = () => {
  return (
    ...
    >
        ...
        >
          <div className="container mx-auto mb-16">
            <div className="grid grid-rows-[auto_1fr]">
              <Link
                className="bg-card border border-border rounded-lg p-6 col-span-full row-span-full gap-y-0 max-lg:grid-rows-subgrid"
                href="/features#agent"
              >
                      ...
                      >
                        <div className="absolute top-0 right-0 bottom-0 left-0 z-10 h-full w-full max-[767px]:pointer-events-none max-[767px]:opacity-0 transition-opacity duration-150">
                          <div className="sr-only" aria-live="polite">
                            ...
                            demonstration of Cursor&apos;s IDE showing AI-powered coding assistance
                            features. The interface is displayed over a scenic painted landscape
                            wallpaper, giving the demo an artistic backdrop.
                          </div>
                ...
                <div className="col-span-full row-start-1 row-end-2 grid lg:row-start-1 lg:row-end-3 lg:items-center lg:col-start-1 lg:col-end-9 lg:pl-g0.25 lg:pr-g3">
                  <div className="max-w-2xl w-full lg:justify-self-start">
                    <div className="text-base flex-1">
                      ...
                      <div className="text-base md:text-lg text-muted-foreground text-pretty">
                        <p>
                          Cursor is in GitHub reviewing your PRs, a teammate in Slack, and anywhere
                          else you work.
                        </p>
                      </div>
                    </div>
                      ...
                      >
                        <div className="absolute top-0 right-0 bottom-0 left-0 z-10 h-full w-full max-[767px]:pointer-events-none max-[767px]:opacity-0 transition-opacity duration-150">
                          <div className="sr-only" aria-live="polite">
                            ...
                            multiple Cursor interfaces: Slack integration for team communication,
                            GitHub integration for code review and debugging. The interfaces are
                            displayed over a scenic painted landscape wallpaper, giving the demo an
                            artistic backdrop.
                          </div>
                          {/* Demo window placeholder */}
                          <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-stretch">
            ...
            <div className="undefined h-full">
              ...
              >
                <div className="text-base flex max-w-2xl flex-1 flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-medium mb-2">Access the best models</h3>
                    <div className="text-muted-foreground text-pretty">
                      <p>
                        Choose between every cutting-edge model from OpenAI, Anthropic, Gemini, and
                        xAI.
                      </p>
                    </div>
                  </div>
            ...
            <div className="undefined h-full">
              <a
                ...
                rel="noopener noreferrer"
                className="bg-card border border-border rounded-lg p-6 flex h-full flex-1 flex-col"
                href="https://docs.cursor.com/context/codebase-indexing"
              >
                <div className="text-base flex max-w-2xl flex-1 flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-medium mb-2">Complete codebase understanding</h3>
                    <div className="text-muted-foreground text-pretty">
                      <p>
            ...
            <div className="undefined h-full">
              ...
              >
                <div className="text-base flex max-w-2xl flex-1 flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-medium mb-2">Develop enduring software</h3>
                    <div className="text-muted-foreground text-pretty">
                      <p>
                        Trusted by over half of the Fortune 500 to accelerate development, securely
                        and at scale.
                      </p>
                    </div>
                  </div>
      ...
      >
        <div className="container mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-normal text-font mb-4">Changelog</h2>
